...
const tracks: Track[] = [
  ...
  },
  {
    ...
    subtitle: "Doenças crônicas • Faixa educativa",
    topic: "Doenças Crônicas",
    src: `${basePath}/audio/numeros-do-diabetes.mp3`,
    color: "teal",
    icon: "DM",
    description: "Memorize os principais valores relacionados ao diabetes e reconheça os números mais cobrados em prova.",
    highlights: ["Glicemia e diagnóstico", "Valores de referência", "Acompanhamento do diabetes"],
  },
  {
    id: 7,
    ...
    subtitle: "Doenças crônicas • Faixa educativa",
    topic: "Doenças Crônicas",
    src: `${basePath}/audio/pressao-alta-atencao.mp3`,
    color: "red",
    icon: "PA!",
    description: "Revise os sinais de alerta, riscos e cuidados essenciais relacionados à hipertensão arterial.",
    highlights: ["Fatores de risco", "Sinais de alerta", "Prevenção de complicações"],
  },
  {
    id: 8,
    ...
    subtitle: "Doenças crônicas • Faixa educativa",
    topic: "Doenças Crônicas",
    src: `${basePath}/audio/pressao-na-medida-certa.mp3`,
    color: "gold",
    icon: "120",
    description: "Aprenda a técnica correta de aferição e fixe os cuidados que garantem uma medida confiável da pressão.",
    highlights: ["Técnica de aferição", "Posicionamento correto", "Erros que alteram a medida"],
  },
  {
    id: 9,
    title: "Decore os Números",
    subtitle: "Doenças crônicas • Faixa educativa",
    topic: "Doenças Crônicas",
    src: `${basePath}/audio/decore-os-numeros.mp3`,
    color: "cyan",
    icon: "#",
    description: "Uma faixa para fixar valores clínicos importantes e ganhar segurança nas questões numéricas do concurso.",
    highlights: ["Valores clínicos", "Associações rápidas", "Revisão para prova"],
  },
  {
    id: 10,
    ...
    subtitle: "Doenças crônicas • Faixa educativa",
    topic: "Doenças Crônicas",
    src: `${basePath}/audio/cuidado-individualizado.mp3`,
    color: "indigo",
    icon: "CI",
    description: "Entenda por que o plano de cuidado deve considerar necessidades, riscos e contexto de cada pessoa.",
    highlights: ["Plano de cuidado", "Metas compartilhadas", "Acompanhamento contínuo"],
  },
];
...
const categories = [
  ...
  { name: "Doenças crônicas", count: "5 faixas", color: "teal", icon: "♥" },
];
